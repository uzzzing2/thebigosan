...
/**
 * Nickname rule:
 *   - starts with a letter (en or ko)
 *   - middle 2~18 chars: en letters / digits / underscore / ko
 *   - ends with a letter or digit (no underscore at end)
 *   - total length 4~20
 */
const NICKNAME_REGEX = /^[a-zA-Z가-힣][a-zA-Z0-9가-힣_]{2,18}[a-zA-Z0-9가-힣]$/
...
export const cheerFormSchema = z.object({
  nickname: z
    ...
    .regex(NICKNAME_REGEX, '한글·영문으로 시작하고 한글·영문·숫자·언더스코어(_)만 사용해주세요'),
  content: z
    .string()
